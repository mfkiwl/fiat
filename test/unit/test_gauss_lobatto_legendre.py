...
def test_gll_basis_values(dim, degree):
    ...
    from FIAT import GaussLobattoLegendre, create_quadrature, reference_element
...
def test_edge_dofs(dim, degree):
    ...
    from FIAT import GaussLobattoLegendre, quadrature, expansions, reference_element
